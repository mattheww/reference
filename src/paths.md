...
Paths starting with `::` are resolved relative to the [extern prelude].
...
```
> **Edition Differences**: In the 2015 edition, paths starting with `::` are
> resolved relative to the current crate root.
>
