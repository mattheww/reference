...
* `'static` is used for the static lifetime and cannot be used as a generic
  ...
  ```
* [`dyn`] is a keyword when used in a type position followed by a path that
  does not start with `::`.

> **Edition Differences**: Beginning in the 2018 edition, `dyn` has been
> promoted to a strict keyword.
